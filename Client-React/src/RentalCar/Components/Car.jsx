...
import { removeCar, setCarModels } from "../redux/Actions";
...
export const Car = (props) => {
    ...
    let carModel = carModels.find(m => m.id == carModelId)
    ...
    const isManager = user && user.userTypeId == userTypes.find(ut => ut.description == "manager").id
